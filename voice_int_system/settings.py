"""
Django settings for voice_int_system project.
...
SECRET_KEY = 'django-insecure-q4nq2ytyc4*+(vnji2tyred*i%cmf6bo9@fkk^5m-2vd$_kzn2'
...
ROOT_URLCONF = 'voice_int_system.urls'
...
WSGI_APPLICATION = 'voice_int_system.wsgi.application'
